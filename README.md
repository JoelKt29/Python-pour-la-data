...
les prix de l’action NVIDIA (ouverture, clôture, plus hauts et plus bas), les volumes échangés, une période suffisamment longue pour analyser les tendances.
...
le chargement et le nettoyage des données, la construction de séries temporelles, le calcul d’indicateurs descriptifs, la visualisation graphique.
...
Des prolongements naturels de ce travail pourraient inclure : une comparaison avec d’autres entreprises du secteur, l’intégration d’indicateurs fondamentaux, ou la mise en place de modèles prédictifs plus avancés.
