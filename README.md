...
Commande d'installation : pip install pandas numpy yfinance pandas-datareader matplotlib seaborn scikit-learn xgboost
...
Final copy.ipynb : Ce notebook présente l'analyse descriptive finale, le calcul de la skewness et l'interprétation économique des résultats.
